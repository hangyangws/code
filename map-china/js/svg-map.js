...
! function(win, $, undefined) {
    var SVGMap = (function() {
        ...
        SVGMap.prototype.options = {
            ...
            mapWidth: 780,
            mapHeight: 500,
            stateColorList: ['303', '306', '309', '30c', '30f', '33f', '36f', '39f', '3cf', '3cc'],
            ...
            stateInitColor: '3cc', //默认颜色
            stateHoverColor: '3f3', //鼠标经过颜色
            stateSelectedColor: '3f3', //鼠标点击选中的颜色
            stateDisabledColor: '999', //没有互动城市的颜色

            showTip: true,
            // stateTipWidth: 100,//提示框宽高
            //stateTipHeight: 50,//提示框宽高
            stateTipX: 0, //提示框的位置
            stateTipY: -10, //提示框的位置
